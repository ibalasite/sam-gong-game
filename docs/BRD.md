...
| O1（Server-authoritative公平性）| 反作弊投訴率≤0.1% | REQ-017 反作弊與速率限制 | BDD S-017; IT-anticheat-001 | 🔲 待填 |
...
| NFR-17 | **安全：JWT Session安全** | Token ≤ 1小時，封號後1分鐘失效；RS256/ES256簽名 | 封號後Token失效 ≤ 60秒 | 封號流程測試 + Token驗證 | Must |
